...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto2\xbe\x03\n" +
	"\n" +
	"SimpleBank\x12\x90\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"S\x92A6\x12\x11Create a new user\x1a!Use this API to create a new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x9c\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"_\x92AB\x12\x17Update an existing user\x1a'Use this API to update an existing user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12~\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"D\x92A(\x12\n" +
	"Login user\x1a\x1aUse this API to login user\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x83\x01\x92A[\x12Y\n" +
	"\x0fSimple Bank API\"A\n" +
	"\rSouvik Mandal\x12\x1dhttps://github.com/souvikmndl\x1a\x11svk72mi@gmail.com2\x031.2Z#github.com/souvikmndl/simplebank/pbb\x06proto3"
